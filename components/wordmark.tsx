 ...
 * assets, so the brand is a letter in Inter on the ink colour, which stays crisp
  ...
  return (
    ...
    >
      <span className={cn("flex items-center gap-2", className)}>
        <span
          aria-hidden="true"
          className="bg-primary text-primary-foreground text-label grid size-7 shrink-0 place-items-center rounded-md font-semibold"
        >
          {VENUE_INITIAL}
        </span>
